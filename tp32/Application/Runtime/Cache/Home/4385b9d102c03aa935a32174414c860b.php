...
<head>
    ...
    <script language="javascript" type="text/javascript" src="/tp32/Public/plugin/My97DatePicker/WdatePicker.js"></script>	
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<div class="container">
		...
		<div class="cardexplain">
			...
			<form action="<?php echo U('msg/sousuo');?>" method="post" class="form1">
				开始时间
				<input class="Wdate" type="text" name='start' onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
				结束时间
				<input class="Wdate" type="text" name='stop' onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
